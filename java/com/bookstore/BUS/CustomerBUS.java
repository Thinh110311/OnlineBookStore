...
public class CustomerBUS {
 ...
 // Tìm kiếm trong danh sách đã có mà không truy vấn DB
    public List<Customer> searchCustomer(List<Customer> list, String value) {
        ...
        for (Customer cus : list) {
            if ((cus.getFullName() != null && cus.getFullName().toLowerCase().contains(value)) ||
                (cus.getPhoneNumber() != null && cus.getPhoneNumber().contains(value))) {
                result.add(cus);
            }
        }
        return result;
